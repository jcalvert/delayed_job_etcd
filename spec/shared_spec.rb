...
shared_examples_for 'a delayed_job backend' do
  ...
  context 'named queues' do
    ...
    context 'when worker does not have queue set' do
      ...
      it 'works off the default queue' do
        expect(SimpleJob.runs).to eq(0)
